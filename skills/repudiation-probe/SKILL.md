# Skill: repudiation-probe

## Purpose
FR : Ce skill encapsule les cas de test TrustGate pour le pilier STRIDE "repudiation-probe".
...
EN : This skill encapsulates TrustGate test cases for STRIDE pillar "repudiation-probe".
...
## How to invoke (Antigravity / agents-cli)
    agents-cli skill load repudiation-probe
