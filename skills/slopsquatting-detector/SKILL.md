# Skill: slopsquatting-detector

## Purpose
FR : Ce skill encapsule les cas de test TrustGate pour le pilier STRIDE "slopsquatting-detector".
...
EN : This skill encapsulates TrustGate test cases for STRIDE pillar "slopsquatting-detector".
...
## How to invoke (Antigravity / agents-cli)
    agents-cli skill load slopsquatting-detector
