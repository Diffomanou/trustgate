...
## Purpose
FR : Ce skill encapsule les cas de test TrustGate pour le pilier STRIDE "dos-probe".
...
EN : This skill encapsulates TrustGate test cases for STRIDE pillar "dos-probe".
...
## How to invoke (Antigravity / agents-cli)
    agents-cli skill load dos-probe
