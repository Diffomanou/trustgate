# Skill: info-disclosure-probe

## Purpose
FR : Ce skill encapsule les cas de test TrustGate pour le pilier STRIDE "info-disclosure-probe".
...
EN : This skill encapsulates TrustGate test cases for STRIDE pillar "info-disclosure-probe".
...
## How to invoke (Antigravity / agents-cli)
    agents-cli skill load info-disclosure-probe
