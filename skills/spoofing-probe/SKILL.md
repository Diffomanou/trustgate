# Skill: spoofing-probe

## Purpose
FR : Ce skill encapsule les cas de test TrustGate pour le pilier STRIDE "spoofing-probe".
...
EN : This skill encapsulates TrustGate test cases for STRIDE pillar "spoofing-probe".
...
## How to invoke (Antigravity / agents-cli)
    agents-cli skill load spoofing-probe
