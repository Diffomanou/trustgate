# Skill: tampering-probe

## Purpose
FR : Ce skill encapsule les cas de test TrustGate pour le pilier STRIDE "tampering-probe".
...
EN : This skill encapsulates TrustGate test cases for STRIDE pillar "tampering-probe".
...
## How to invoke (Antigravity / agents-cli)
    agents-cli skill load tampering-probe
